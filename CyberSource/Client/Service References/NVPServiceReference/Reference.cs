...
namespace CyberSource.Clients.NVPServiceReference {
    ...
    public interface INVPTransactionProcessor {
        ...
        [System.ServiceModel.OperationContractAttribute(Action="runTransaction", ReplyAction="*")]
        System.Threading.Tasks.Task<CyberSource.Clients.NVPServiceReference.outputNVPMessageOut> runTransactionAsync(CyberSource.Clients.NVPServiceReference.inputNVPMessageIn request);
    }
    ...
    public partial class inputNVPMessageIn {
        ...
        [System.ServiceModel.MessageBodyMemberAttribute(Namespace="urn:schemas-cybersource-com:transaction-data-1.147", Order=0)]
    ...
    public partial class NVPTransactionProcessorClient : System.ServiceModel.ClientBase<CyberSource.Clients.NVPServiceReference.INVPTransactionProcessor>, CyberSource.Clients.NVPServiceReference.INVPTransactionProcessor {
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        System.Threading.Tasks.Task<CyberSource.Clients.NVPServiceReference.outputNVPMessageOut> CyberSource.Clients.NVPServiceReference.INVPTransactionProcessor.runTransactionAsync(CyberSource.Clients.NVPServiceReference.inputNVPMessageIn request) {
            return base.Channel.runTransactionAsync(request);
        }
        
        public System.Threading.Tasks.Task<CyberSource.Clients.NVPServiceReference.outputNVPMessageOut> runTransactionAsync(string nvpRequest) {
            CyberSource.Clients.NVPServiceReference.inputNVPMessageIn inValue = new CyberSource.Clients.NVPServiceReference.inputNVPMessageIn();
            inValue.nvpRequest = nvpRequest;
            return ((CyberSource.Clients.NVPServiceReference.INVPTransactionProcessor)(this)).runTransactionAsync(inValue);
        }
    }
}
